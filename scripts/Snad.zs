...
craftingTable.addShaped("snad_snad", <item:snad:snad>, [
    [<tag:items:forge:sand/colorless>, <item:woldsvaults:vault_essence_block>, <tag:items:forge:sand/colorless>],
    [<item:woldsvaults:vault_essence_block>, <item:the_vault:extraordinary_larimar>, <item:woldsvaults:vault_essence_block>],
    [<tag:items:forge:sand/colorless>, <item:woldsvaults:vault_essence_block>, <tag:items:forge:sand/colorless>]
]);

craftingTable.addShaped("snad_red_snad", <item:snad:red_snad>, [
     [<tag:items:forge:sand/red>, <item:woldsvaults:vault_essence_block>, <tag:items:forge:sand/red>],
    [<item:woldsvaults:vault_essence_block>, <item:the_vault:extraordinary_larimar>, <item:woldsvaults:vault_essence_block>],
    [<tag:items:forge:sand/red>, <item:woldsvaults:vault_essence_block>, <tag:items:forge:sand/red>]
]);

craftingTable.addShaped("snad_soul_snad", <item:snad:suol_snad>, [
    [<item:minecraft:soul_sand>, <item:woldsvaults:vault_essence_block>, <item:minecraft:soul_sand>],
    [<item:woldsvaults:vault_essence_block>, <item:the_vault:extraordinary_larimar>, <item:woldsvaults:vault_essence_block>],
    [<item:minecraft:soul_sand>, <item:woldsvaults:vault_essence_block>, <item:minecraft:soul_sand>]
]);
*/
