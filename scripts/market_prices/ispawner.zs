...
val priceTable as int[IItemStack] = {
    <item:ispawner:cage_dust> : 2075,
    <item:ispawner:cage_piece> : 0,
    <item:ispawner:spawn_egg> : 0,
    <item:ispawner:spawner> : 0,
    <item:ispawner:spawner_controller> : 0,
    <item:ispawner:survival_spawner> : 0
};
