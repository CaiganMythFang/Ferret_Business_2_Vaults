...
val priceTable as int[IItemStack] = {
    <item:tinygates:and_gate_item> : 50,
    <item:tinygates:clock_item> : 50,
    <item:tinygates:counter_item> : 925,
    <item:tinygates:edge_detector_item> : 1125,
    <item:tinygates:not_gate_item> : 25,
    <item:tinygates:or_gate_item> : 50,
    <item:tinygates:rs_latch_item> : 25,
    <item:tinygates:t_flip_flop_item> : 200,
    <item:tinygates:xor_gate_item> : 50
};
