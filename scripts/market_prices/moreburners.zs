...
val priceTable as int[IItemStack] = {
    <item:moreburners:incomplete_heat_upgrade:> : 0,
    <item:moreburners:converter_cover:> : 37500,
    <item:moreburners:electric_burner:> : 3000,
    <item:moreburners:heat_converter:> : 37950,
    <item:moreburners:copper_coil:> : 525,
    <item:moreburners:heat_upgrade:> : 525,
    <item:moreburners:nickel_coil:> : 500
};
