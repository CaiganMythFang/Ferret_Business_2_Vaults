...
val priceTable as int[IItemStack] = {
    <item:integratedterminals:terminal_storage_portable> : 198950,
    <item:integratedterminals:part_terminal_crafting_job> : 42725,
    <item:integratedterminals:part_terminal_storage> : 77700,
    <item:integratedterminals:chorus_glass> : 25,
    <item:integratedterminals:menril_glass> : 2
};
