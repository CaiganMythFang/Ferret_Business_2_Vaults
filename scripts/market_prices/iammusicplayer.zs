...
val priceTable as int[IItemStack] = {
    <item:iammusicplayer:antenna> : 475,
    <item:iammusicplayer:boombox> : 2550,
    <item:iammusicplayer:cassette_deck> : 2950,
    <item:iammusicplayer:cassette_tape> : 50,
    <item:iammusicplayer:cassette_tape_glass> : 50,
    <item:iammusicplayer:manual> : 50,
    <item:iammusicplayer:music_manager> : 3025,
    <item:iammusicplayer:parabolic_antenna> : 1000
};
