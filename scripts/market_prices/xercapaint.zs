...
val priceTable as int[IItemStack] = {
    <item:xercapaint:item_canvas> : 10,
    <item:xercapaint:item_canvas_large> : 25,
    <item:xercapaint:item_canvas_long> : 25,
    <item:xercapaint:item_canvas_tall> : 25,
    <item:xercapaint:item_easel> : 5,
    <item:xercapaint:item_palette> : 2
