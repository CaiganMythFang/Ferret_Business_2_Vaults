...
val priceTable as int[IItemStack] = {
    <item:easy_villagers:auto_trader> : 39675,
    <item:easy_villagers:farmer> : 1050,
    <item:easy_villagers:iron_farm> : 18150,
    <item:easy_villagers:trader> : 225,
    <item:easy_villagers:breeder> : 475,
    <item:easy_villagers:converter> : 475,
    <item:easy_villagers:incubator> : 475,
    <item:easy_villagers:villager> : 250
};
