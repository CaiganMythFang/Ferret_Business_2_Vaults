...
val priceTable as int[IItemStack] = {
    <item:railways:yellow_incomplete_conductor_cap> : 0,
    <item:railways:white_incomplete_conductor_cap> : 0,
    <item:railways:track_incomplete_warped> : 0,
    <item:railways:track_incomplete_monorail> : 0,
    <item:railways:track_incomplete_oak> : 0,
    <item:railways:orange_incomplete_conductor_cap> : 0,
    <item:railways:track_incomplete_phantom> : 0,
    <item:railways:track_incomplete_acacia> : 0,
    <item:railways:purple_incomplete_conductor_cap> : 0,
    <item:railways:track_incomplete_dark_oak> : 0,
    <item:railways:cyan_incomplete_conductor_cap> : 0,
    <item:railways:track_incomplete_crimson> : 0,
    <item:railways:green_incomplete_conductor_cap> : 0,
    <item:railways:gray_incomplete_conductor_cap> : 0,
    <item:railways:track_incomplete_ender> : 0,
    <item:railways:track_incomplete_hexcasting_edified> : 0,
    <item:railways:track_incomplete_birch> : 0,
    <item:railways:black_incomplete_conductor_cap> : 0,
    <item:railways:track_incomplete_blackstone> : 0,
    <item:railways:blue_incomplete_conductor_cap> : 0,
    <item:railways:brown_incomplete_conductor_cap> : 0,
    <item:railways:track_incomplete_jungle> : 0,
    <item:railways:light_blue_incomplete_conductor_cap> : 0,
    <item:railways:light_gray_incomplete_conductor_cap> : 0,
    <item:railways:lime_incomplete_conductor_cap> : 0,
    <item:railways:magenta_incomplete_conductor_cap> : 0,
    <item:railways:track_incomplete_tieless> : 0,
    <item:railways:track_incomplete_spruce> : 0,
    <item:railways:red_incomplete_conductor_cap> : 0,
    <item:railways:pink_incomplete_conductor_cap> : 0,
