...
val priceTable as int[IItemStack] = {
    <item:technoblade_plushies:technoblade_shrine> : 3825,
    <item:technoblade_plushies:technoblade_sitting_plush> : 125,
    <item:technoblade_plushies:technoblade_sleeping_plushie> : 125
};
