...
val priceTable as int[IItemStack] = {
    <item:buildinggadgets:gadget_destruction> : 37475,
    <item:buildinggadgets:construction_paste_container_t2> : 10675,
    <item:buildinggadgets:construction_paste_container_t3> : 51700,
    <item:buildinggadgets:gadget_building> : 4375,
    <item:buildinggadgets:gadget_copy_paste> : 7425,
    <item:buildinggadgets:gadget_exchanging> : 12075,
    <item:buildinggadgets:template_manager> : 4645,
    <item:buildinggadgets:construction_block> : 25,
    <item:buildinggadgets:construction_block_dense> : 25,
    <item:buildinggadgets:construction_block_powder> : 25,
    <item:buildinggadgets:construction_paste> : 5,
    <item:buildinggadgets:construction_paste_container_t1> : 1825
};
