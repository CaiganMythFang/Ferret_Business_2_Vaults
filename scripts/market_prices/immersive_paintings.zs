...
val priceTable as int[IItemStack] = {
    <item:immersive_paintings:glow_graffiti> : 125,
    <item:immersive_paintings:glow_painting> : 50,
    <item:immersive_paintings:graffiti> : 100,
    <item:immersive_paintings:painting> : 10
};
