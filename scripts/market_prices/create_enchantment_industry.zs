...
val priceTable as int[IItemStack] = {
    <item:create_enchantment_industry:printer> : 567625,
    <item:create_enchantment_industry:disenchanter> : 10550,
    <item:create_enchantment_industry:hyper_experience_bottle> : 1075,
    <item:create_enchantment_industry:enchanting_guide> : 25,
    <item:create_enchantment_industry:experience_rotor> : 600,
    <item:create_enchantment_industry:ink_bucket> : 700
};
