...
val priceTable as int[IItemStack] = {
    <item:hardcorequesting:basic_bag> : 0,
    <item:hardcorequesting:enabled_quest_book> : 0,
    <item:hardcorequesting:epic_bag> : 0,
    <item:hardcorequesting:good_bag> : 0,
    <item:hardcorequesting:greater_bag> : 0,
    <item:hardcorequesting:halfheart> : 0,
    <item:hardcorequesting:heart> : 0,
    <item:hardcorequesting:hqm_invalid_item> : 0,
    <item:hardcorequesting:legendary_bag> : 0,
    <item:hardcorequesting:quarterheart> : 0,
    <item:hardcorequesting:quest_tracker> : 0,
    <item:hardcorequesting:rottenheart> : 0,
    <item:hardcorequesting:threequartsheart> : 0,
    <item:hardcorequesting:quest_book> : 10,
    <item:hardcorequesting:item_barrel> : 25
};
