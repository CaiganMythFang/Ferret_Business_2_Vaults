...
val priceTable as int[IItemStack] = {
    <item:itemfilters:always_false> : 2,
    <item:itemfilters:always_true> : 2,
    <item:itemfilters:and> : 2,
    <item:itemfilters:block> : 2,
    <item:itemfilters:custom> : 2,
    <item:itemfilters:damage> : 2,
    <item:itemfilters:id_regex> : 2,
    <item:itemfilters:item_group> : 2,
    <item:itemfilters:max_count> : 2,
    <item:itemfilters:mod> : 2,
    <item:itemfilters:not> : 2,
    <item:itemfilters:or> : 2,
    <item:itemfilters:strong_nbt> : 2,
    <item:itemfilters:tag> : 2,
    <item:itemfilters:weak_nbt> : 2,
    <item:itemfilters:xor> : 2
};
