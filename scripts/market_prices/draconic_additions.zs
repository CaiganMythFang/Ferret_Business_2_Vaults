...
val priceTable as int[IItemStack] = {
    <item:draconicadditions:inert_potato_boots> : 25,
    <item:draconicadditions:inert_potato_chest> : 50,
    <item:draconicadditions:inert_potato_helm> : 25,
    <item:draconicadditions:inert_potato_legs> : 50
};
