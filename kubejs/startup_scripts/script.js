...
onEvent('item.registry', event => {
	...
	event.create('tfb2:grist_carbs').group('tfb2').displayName('Grist - Carbs')
	event.create('tfb2:grist_boxium').group('tfb2').displayName('Grist - Boxium')
	event.create('tfb2:grist_chroma').group('tfb2').displayName('Grist - Chroma')
	event.create('tfb2:grist_deserialized').group('tfb2').displayName('Grist - Deserialized')
	event.create('tfb2:grist_ego').group('tfb2').displayName('Grist - Ego')
	event.create('tfb2:grist_fopium').group('tfb2').displayName('Grist - Fopium')
	event.create('tfb2:grist_junkite').group('tfb2').displayName('Grist - Junkite')
	...
	event.create('tfb2:grist_scrappy').group('tfb2').displayName('Grist - Scrappy')
	event.create('tfb2:grist_the_world').group('tfb2').displayName('Grist - The World')
	event.create('tfb2:grist_vitaminv').group('tfb2').displayName('Grist - Vitamin V')
	event.create('tfb2:grist_greed').group('tfb2').displayName('Grist - Greed')
