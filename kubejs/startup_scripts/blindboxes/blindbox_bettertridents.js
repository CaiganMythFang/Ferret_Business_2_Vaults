// bettertridents Blind Box
// amazing
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_bettertridents_cheap')
		.displayName('Cheap Blind Box - Goat Dig')
		.maxStackSize(64)
		.rarity(RARITY_EPIC)
		.group('tfb2')
});
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_bettertridents_cheap', (item, advanced, text) => {
