...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_alexsmobs_cheap')
		.displayName('Cheap Blind Box - Kangaroo Rip')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_alexsmobs_cheap', (item, advanced, text) => {
