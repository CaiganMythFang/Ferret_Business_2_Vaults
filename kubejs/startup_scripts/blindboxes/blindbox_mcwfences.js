...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_mcwfences_cheap')
		.displayName('Cheap Blind Box - Panda Strike')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_mcwfences_cheap', (item, advanced, text) => {
