...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_waystones_decent')
		.displayName('Decent Blind Box - Raccoon Grin')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_waystones_decent', (item, advanced, text) => {
