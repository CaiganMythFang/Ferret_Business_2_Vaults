// mcwbridges Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_mcwbridges_cheap')
		.displayName('Cheap Blind Box - Alligator Steal')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_mcwbridges_cheap', (item, advanced, text) => {
