...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_auxiliary_blocks_cheap')
		.displayName('Cheap Blind Box - Aardvark Gap')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_auxiliary_blocks_cheap', (item, advanced, text) => {
