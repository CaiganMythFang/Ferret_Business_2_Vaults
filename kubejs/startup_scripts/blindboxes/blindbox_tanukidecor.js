// tanukidecor Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_tanukidecor_cheap')
		.displayName('Cheap Blind Box - Dragon Hug')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_tanukidecor_cheap', (item, advanced, text) => {
