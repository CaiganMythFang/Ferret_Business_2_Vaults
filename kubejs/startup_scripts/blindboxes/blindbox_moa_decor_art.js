// moa_decor_art Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_moa_decor_art_cheap')
		.displayName('Cheap Blind Box - Toucan Board')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_moa_decor_art_cheap', (item, advanced, text) => {
