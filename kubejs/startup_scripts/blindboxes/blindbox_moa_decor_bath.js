...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_moa_decor_bath_cheap')
		.displayName('Cheap Blind Box - Lizard Squiggle')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_moa_decor_bath_cheap', (item, advanced, text) => {
