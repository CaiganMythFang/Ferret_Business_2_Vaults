// measurements Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_measurements_cheap')
		.displayName('Cheap Blind Box - Alpaca Plant')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_measurements_cheap', (item, advanced, text) => {
