...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_scannable_good', (item, advanced, text) => {
...
// amazing
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_scannable_amazing')
		.displayName('Amazing Blind Box - Fox Hug')
		.maxStackSize(64)
		.rarity(RARITY_EPIC)
		.group('tfb2')
});
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_scannable_amazing', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
