// mcwfurnitures Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_mcwfurnitures_cheap')
		.displayName('Cheap Blind Box - Toucan Jig')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_mcwfurnitures_cheap', (item, advanced, text) => {
