...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_mcwholidays_cheap')
		.displayName('Cheap Blind Box - Mouse Rob')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_mcwholidays_cheap', (item, advanced, text) => {
