...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_trashcans_cheap')
		.displayName('Cheap Blind Box - Fennec Inject')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_trashcans_cheap', (item, advanced, text) => {
