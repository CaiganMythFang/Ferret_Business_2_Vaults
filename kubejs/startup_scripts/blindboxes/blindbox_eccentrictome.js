// eccentrictome Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_eccentrictome_cheap')
		.displayName('Cheap Blind Box - Ferret Horror')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_eccentrictome_cheap', (item, advanced, text) => {
