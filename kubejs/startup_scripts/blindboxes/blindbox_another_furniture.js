...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_another_furniture_cheap')
		.displayName('Cheap Blind Box - Dog Spark')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_another_furniture_cheap', (item, advanced, text) => {
