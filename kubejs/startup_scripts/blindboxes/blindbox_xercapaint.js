// xercapaint Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_xercapaint_cheap')
		.displayName('Cheap Blind Box - Aardvark Climb')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_xercapaint_cheap', (item, advanced, text) => {
