// vaultfilters Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_vaultfilters_cheap')
		.displayName('Cheap Blind Box - Moth Spell')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_vaultfilters_cheap', (item, advanced, text) => {
