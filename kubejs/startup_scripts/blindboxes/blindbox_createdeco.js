// createdeco Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_createdeco_cheap')
		.displayName('Cheap Blind Box - Squirrel Glare')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_createdeco_cheap', (item, advanced, text) => {
...
// decent
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_createdeco_decent')
		.displayName('Decent Blind Box - Frog Shoot')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_createdeco_decent', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_createdeco_good', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
