// blockcarpentry Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_blockcarpentry_cheap')
		.displayName('Cheap Blind Box - Pangolin Chain')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_blockcarpentry_cheap', (item, advanced, text) => {
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_blockcarpentry_decent', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
...
// good
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_blockcarpentry_good')
		.displayName('Good Blind Box - Aardvark Slide')
		.maxStackSize(64)
		.rarity(RARITY_RARE)
		.group('tfb2')
});
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_blockcarpentry_good', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
