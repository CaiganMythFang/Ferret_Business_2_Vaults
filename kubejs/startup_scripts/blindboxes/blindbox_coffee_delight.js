// coffee_delight Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_coffee_delight_cheap')
		.displayName('Cheap Blind Box - Horse Logic')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_coffee_delight_cheap', (item, advanced, text) => {
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_coffee_delight_decent', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
