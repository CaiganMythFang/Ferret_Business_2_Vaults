...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_cccbridge_decent')
		.displayName('Decent Blind Box - Pangolin Patch')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_cccbridge_decent', (item, advanced, text) => {
