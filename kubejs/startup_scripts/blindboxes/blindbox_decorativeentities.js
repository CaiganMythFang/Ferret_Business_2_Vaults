...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_decorativeentities_cheap')
		.displayName('Cheap Blind Box - Goat Cross')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_decorativeentities_cheap', (item, advanced, text) => {
