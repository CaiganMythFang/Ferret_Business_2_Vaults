// mannequins Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_mannequins_cheap')
		.displayName('Cheap Blind Box - Hippopotamus Eldritch')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_mannequins_cheap', (item, advanced, text) => {
