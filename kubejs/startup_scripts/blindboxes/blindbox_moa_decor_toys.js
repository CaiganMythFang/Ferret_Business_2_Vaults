...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_moa_decor_toys_cheap')
		.displayName('Cheap Blind Box - Hare Smoke')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_moa_decor_toys_cheap', (item, advanced, text) => {
