// vaultfruitbag Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_vaultfruitbag_cheap')
		.displayName('Cheap Blind Box - Cat Sword')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_vaultfruitbag_cheap', (item, advanced, text) => {
