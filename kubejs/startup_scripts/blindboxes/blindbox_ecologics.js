...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_ecologics_cheap')
		.displayName('Cheap Blind Box - Hamster Hunt')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_ecologics_cheap', (item, advanced, text) => {
