...
// onEvent('item.registry', event => {
	// event.create('tfb2:blindbox_decorative_gaming_consoles_cheap')
		// .displayName('Cheap Blind Box - Dragon Nibble')
		// .maxStackSize(64)
...
// onEvent('item.tooltip', tooltip => {
	// tooltip.addAdvanced('tfb2:blindbox_decorative_gaming_consoles_cheap', (item, advanced, text) => {
