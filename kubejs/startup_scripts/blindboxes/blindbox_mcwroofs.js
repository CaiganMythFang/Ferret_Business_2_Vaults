...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_mcwroofs_cheap')
		.displayName('Cheap Blind Box - Binturong Drink')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_mcwroofs_cheap', (item, advanced, text) => {
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_mcwroofs_decent', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
