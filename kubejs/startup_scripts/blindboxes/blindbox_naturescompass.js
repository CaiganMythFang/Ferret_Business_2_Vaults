// naturescompass Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_naturescompass_cheap')
		.displayName('Cheap Blind Box - Shark Fold')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_naturescompass_cheap', (item, advanced, text) => {
