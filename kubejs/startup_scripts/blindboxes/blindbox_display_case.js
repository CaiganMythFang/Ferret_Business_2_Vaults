// display_case Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_display_case_cheap')
		.displayName('Cheap Blind Box - Rat Fly')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_display_case_cheap', (item, advanced, text) => {
