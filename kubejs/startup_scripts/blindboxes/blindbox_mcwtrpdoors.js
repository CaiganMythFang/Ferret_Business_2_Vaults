// mcwtrpdoors Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_mcwtrpdoors_cheap')
		.displayName('Cheap Blind Box - Dragon Batch')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_mcwtrpdoors_cheap', (item, advanced, text) => {
