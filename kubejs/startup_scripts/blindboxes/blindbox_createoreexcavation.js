// createoreexcavation Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_createoreexcavation_cheap')
		.displayName('Cheap Blind Box - Dormouse Farm')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_createoreexcavation_cheap', (item, advanced, text) => {
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_createoreexcavation_decent', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
...
// good
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_createoreexcavation_good')
		.displayName('Good Blind Box - Skunk Bounce')
		.maxStackSize(64)
		.rarity(RARITY_RARE)
		.group('tfb2')
});
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_createoreexcavation_good', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_createoreexcavation_amazing', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
