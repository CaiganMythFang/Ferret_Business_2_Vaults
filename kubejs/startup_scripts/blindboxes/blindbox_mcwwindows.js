// mcwwindows Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_mcwwindows_cheap')
		.displayName('Cheap Blind Box - Alpaca Shoot')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_mcwwindows_cheap', (item, advanced, text) => {
