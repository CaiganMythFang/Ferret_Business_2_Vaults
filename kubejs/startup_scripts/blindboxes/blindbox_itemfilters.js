// itemfilters Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_itemfilters_cheap')
		.displayName('Cheap Blind Box - Dormouse Hover')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_itemfilters_cheap', (item, advanced, text) => {
