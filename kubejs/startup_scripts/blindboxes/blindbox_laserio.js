...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_laserio_decent')
		.displayName('Decent Blind Box - Binturong Generate')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_laserio_decent', (item, advanced, text) => {
