...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_sfm_decent', (item, advanced, text) => {
...
// amazing
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_sfm_amazing')
		.displayName('Amazing Blind Box - Aardvark Strike')
		.maxStackSize(64)
		.rarity(RARITY_EPIC)
		.group('tfb2')
});
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_sfm_amazing', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
