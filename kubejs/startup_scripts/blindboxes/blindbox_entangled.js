...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_entangled_decent', (item, advanced, text) => {
...
// good
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_entangled_good')
		.displayName('Good Blind Box - Motmot Jig')
		.maxStackSize(64)
		.rarity(RARITY_RARE)
		.group('tfb2')
});
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_entangled_good', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
