...
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_appmek_cheap')
		.displayName('Cheap Blind Box - Bee Spooky')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_appmek_cheap', (item, advanced, text) => {
...
// decent
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_appmek_decent')
		.displayName('Decent Blind Box - Panda Slide')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_appmek_decent', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
...
// good
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_appmek_good')
		.displayName('Good Blind Box - Rabbit Plant')
		.maxStackSize(64)
		.rarity(RARITY_RARE)
		.group('tfb2')
});
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_appmek_good', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_appmek_amazing', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
