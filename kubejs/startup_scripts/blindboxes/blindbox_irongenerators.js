// irongenerators Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_irongenerators_cheap')
		.displayName('Cheap Blind Box - Raccoon Weird')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_irongenerators_cheap', (item, advanced, text) => {
...
// decent
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_irongenerators_decent')
		.displayName('Decent Blind Box - Otter Fly')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_irongenerators_decent', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_irongenerators_good', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_irongenerators_amazing', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
