// botanypots Blind Box
// decent
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_botanypots_decent')
		.displayName('Decent Blind Box - Mink Love')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_botanypots_decent', (item, advanced, text) => {
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_botanypots_good', (item, advanced, text) => {
		text.add(1, [Text.of('A Ferret Business Blind Box! Right Click it to see what you get!').lightPurple()])
