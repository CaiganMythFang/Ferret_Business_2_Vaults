// fairylights Blind Box
// cheap
onEvent('item.registry', event => {
	event.create('tfb2:blindbox_fairylights_cheap')
		.displayName('Cheap Blind Box - Butterfly Fancy')
		.maxStackSize(64)
...
onEvent('item.tooltip', tooltip => {
	tooltip.addAdvanced('tfb2:blindbox_fairylights_cheap', (item, advanced, text) => {
