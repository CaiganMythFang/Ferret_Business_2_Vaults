...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_createaddition_decent') {
	...
	event.player.tell(Text.lightPurple("You open up an Marten Smoke Blind Box!"));
...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_createaddition_good') {
	...
	event.player.tell(Text.lightPurple("You open up an Panda Dance Blind Box!"));
...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_createaddition_amazing') {
	...
	event.player.tell(Text.lightPurple("You open up an Butterfly Fierce Blind Box!"));
