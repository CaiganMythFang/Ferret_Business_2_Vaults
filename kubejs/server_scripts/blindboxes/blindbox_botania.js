...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_botania_decent') {
	...
	event.player.tell(Text.lightPurple("You open up an Lizard Link Blind Box!"));
...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_botania_good') {
	...
	event.player.tell(Text.lightPurple("You open up an Horse Grin Blind Box!"));
...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_botania_amazing') {
	...
	event.player.tell(Text.lightPurple("You open up an Iguana Love Blind Box!"));
