onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_luphieclutteredmod_cheap') {
	  
	event.server.runCommandSilent('loot give ' + event.getEntity() + ' loot tfb2:luphieclutteredmod/luphieclutteredmod_cheap');
	event.player.tell(Text.lightPurple("You open up an Raccoon Run Blind Box!"));
