onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_integratedterminals_cheap') {
	...
	event.player.tell(Text.lightPurple("You open up an Panda Crime Blind Box!"));
...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_integratedterminals_good') {
	...
	event.player.tell(Text.lightPurple("You open up an Hare Scroll Blind Box!"));
...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_integratedterminals_amazing') {
	...
	event.player.tell(Text.lightPurple("You open up an Crab Bop Blind Box!"));
