...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_cagerium_decent') {
	...
	event.player.tell(Text.lightPurple("You open up an Lion Climb Blind Box!"));
...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_cagerium_good') {
	...
	event.player.tell(Text.lightPurple("You open up an Frog Grin Blind Box!"));
...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_cagerium_amazing') {
	...
	event.player.tell(Text.lightPurple("You open up an Lion Hug Blind Box!"));
