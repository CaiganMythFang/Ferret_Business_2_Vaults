onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_easy_piglins_decent') {
	  
	event.server.runCommandSilent('loot give ' + event.getEntity() + ' loot tfb2:easy_piglins/easy_piglins_decent');
	event.player.tell(Text.lightPurple("You open up an Rat Tortilla Blind Box!"));
