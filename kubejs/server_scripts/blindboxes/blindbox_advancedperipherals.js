...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_advancedperipherals_decent') {
	...
	event.player.tell(Text.lightPurple("You open up an Motmot Patch Blind Box!"));
...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_advancedperipherals_good') {
	...
	event.player.tell(Text.lightPurple("You open up an Alligator Fierce Blind Box!"));
...
onEvent('item.right_click', event => {
  ...
  if (event.item.id == 'tfb2:blindbox_advancedperipherals_amazing') {
	...
	event.player.tell(Text.lightPurple("You open up an Frog Board Blind Box!"));
